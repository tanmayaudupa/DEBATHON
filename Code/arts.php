...
<div style="position: absolute;left:20%;
    top:18%;">
    <h1 style="font-family:Book Antiqua;color:red" align=center><i>Arts</i></h1>
    <hr width="800px"> 
    <table>
    <tr>
    <td>
      ...
      $query = "SELECT Category,Topic,Description,Yes,No,Sum FROM details WHERE Category='Arts' ORDER BY Sum DESC";
      $result2=mysqli_query($conn,$query);
      while($rows=$result2->fetch_assoc())  
      { 
        echo "<div class=\"test\" style=\"margin-top: 0.25cm;height: 140px;padding:10px;border-radius: 5px;background-color: Bisque\" >";
        echo $rows['Category'];
        echo "<br/>";
        echo $rows['Topic'];
        echo "<br><br> ";
        ...
        echo "<br>";
        echo "<form style=\"margin-top: 0.8mm;position: absolute;margin-left: 10cm;width: 80px\" action=\"taker.php\"><input type=\"submit\" value=\"Yes\"></form>";
        echo "<br>";
        echo "<br>";
