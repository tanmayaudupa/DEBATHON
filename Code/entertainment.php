...
<div style="position: absolute;left:20%;
    top:18%;">
    <h1 style="font-family:Book Antiqua;color:red" align=center><i>Entertainment</i></h1>
    <hr width="800px"> 
    <table>
    <tr>
    <td>
      ...
      $query = "SELECT Category,Topic,Description,Yes,No,Sum FROM details WHERE Category='Entertainment' ORDER BY Sum DESC";
